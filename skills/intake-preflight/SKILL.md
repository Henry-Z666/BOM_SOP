...
Invoke `intake-preflight` through `SkillRuntime` or `skill_cli`; do not call its implementation directly. It emits `preflight-report/v1` and `input-manifest/v1` artifacts.
