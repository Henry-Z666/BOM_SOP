...
& $runtime.JavacCommand --release 17 -cp $classpath -d $output (Join-Path $PSScriptRoot 'src\AutoCadDiscovery.java') (Join-Path $PSScriptRoot 'src\EmbeddedFirstImage.java') (Join-Path $PSScriptRoot 'src\ArrowProjection.java') (Join-Path $PSScriptRoot 'src\RenderAssemblyImage.java') (Join-Path $PSScriptRoot 'src\NativeArrowBatch.java') (Join-Path $PSScriptRoot 'src\NativeArrowWorker.java') (Join-Path $PSScriptRoot 'src\PixelArrowCompatibility.java') (Join-Path $PSScriptRoot 'src\PixelArrowBaseBatchV3.java') (Join-Path $PSScriptRoot 'src\CameraBasisDiscovery.java')
